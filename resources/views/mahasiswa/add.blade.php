                ...
                <div class="p-6">
                    <form action="{{ route('mahasiswa.store') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="nim" class="block mt-1 w-full" type="text" name="nim" :value="old('nim')" required autocomplete="username" />
                            <x-input-error :messages="$errors->get('nim')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="angkatan" :value="__('angkatan')" />
                            <x-text-input id="angkatan" class="block mt-1 w-full" type="number" name="angkatan" :value="old('angkatan')" required autocomplete="username" />
